...
class test
{
        int b;  //it will initialize first
        int a;  //it will initialize second
    public:
        ...
        // test(int i,int j) : a(i),b(a+j)     //Output:3 and grbg_value
        // test(int i,int j) : b(j),a(i)       //Output:3 and 5
        // test(int i,int j) : b(j),a(b+i)     //Output:8 and 5
